...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'qa_question', 'question_text', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Question.question_text'
        db.alter_column(u'qa_question', 'question_text', self.gf('django.db.models.fields.CharField')(max_length=200))
